...
(cond ((= 2 0) 'thanksgiving)
  ((= 3 3))
  (else 'turkey))
; expect True

(cond ((= 0 0) 'stuffing 12)
  (else 'cranberry 0))
; expect 12
...
( let ((a (list 1 2)) (b (list 3 4 ))) (cons a b ))
; expect ((1 2) 3 4)

( let ((a (list 1 2)) (b (list 3 4 ))) (append a b ))
; expect (1 2 3 4)
